...
public class AgentPro_ProductionOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    ...
    public static final String OPERATION_REQUIRESOPERATION="requiresOperation";
    public static final String OPERATION_BUFFER_AFTER_OPERATION_START="buffer_after_operation_start";
    ...
    public static final String OPERATION_BUFFER_AFTER_OPERATION_END="buffer_after_operation_end";
    ...
    public static final String OPERATION_BUFFER_BEFORE_OPERATION_START="buffer_before_operation_start";
    public static final String OPERATION_BUFFER_BEFORE_OPERATION_END="buffer_before_operation_end";
    ...
    public static final String ALLOCATEDWORKINGSTEP_QUANTITY="quantity";
    ...
    public static final String ALLOCATEDWORKINGSTEP_LASTOPERATION="lastOperation";
    ...
    public static final String PRODUCTION_OPERATION_REQUIRESMATERIAL="requiresMaterial";
    ...
    public static final String ORDEREDOPERATION_HASPRODUCTIONOPERATION="hasProductionOperation";
    ...
    public static final String REQUEST_DATABASEENTRY_ENDDATE="enddate";
    public static final String REQUEST_DATABASEENTRY_STARTDATE="startdate";
  ...
  */
  private AgentPro_ProductionOntology(){ 
    ...
    add(materialSchema, agentPro.onto.Material.class);
    ...
    request_DatabaseEntrySchema.add(REQUEST_DATABASEENTRY_STARTDATE, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    request_DatabaseEntrySchema.add(REQUEST_DATABASEENTRY_ENDDATE, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    ...
    orderedOperationSchema.add(ORDEREDOPERATION_HASPRODUCTIONOPERATION, production_OperationSchema, ObjectSchema.OPTIONAL);
    ...
    production_OperationSchema.add(PRODUCTION_OPERATION_REQUIRESMATERIAL, materialSchema, ObjectSchema.OPTIONAL);
    ...
    allocatedWorkingStepSchema.add(ALLOCATEDWORKINGSTEP_LASTOPERATION, (TermSchema)getSchema(BasicOntology.BOOLEAN), ObjectSchema.OPTIONAL);
    ...
    allocatedWorkingStepSchema.add(ALLOCATEDWORKINGSTEP_QUANTITY, (TermSchema)getSchema(BasicOntology.INTEGER), ObjectSchema.OPTIONAL);
    ...
    materialSchema.add(MATERIAL_NAME, (TermSchema)getSchema(BasicOntology.STRING), ObjectSchema.OPTIONAL);
    operationSchema.add(OPERATION_NAME, (TermSchema)getSchema(BasicOntology.STRING), ObjectSchema.OPTIONAL);
    operationSchema.add(OPERATION_BUFFER_BEFORE_OPERATION_END, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    operationSchema.add(OPERATION_BUFFER_BEFORE_OPERATION_START, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    ...
    operationSchema.add(OPERATION_BUFFER_AFTER_OPERATION_END, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    ...
    operationSchema.add(OPERATION_BUFFER_AFTER_OPERATION_START, (TermSchema)getSchema(BasicOntology.FLOAT), ObjectSchema.OPTIONAL);
    operationSchema.add(OPERATION_REQUIRESOPERATION, operationSchema, 0, ObjectSchema.UNLIMITED);
