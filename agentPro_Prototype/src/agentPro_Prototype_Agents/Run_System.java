...
public class Run_System {
	 ...
	 public static void main(String[] args){
	        ...
	        //String paramlist = "DatabaseConnectorAgent:agentPro_Prototype_Agents.DatabaseConnectorAgent();Simulation_Infrastrucutre:agentPro_Prototype_Agents._Simulation_Order_Generator;InterfaceAgent:agentPro_Prototype_Agents.InterfaceAgent();Test:agentPro_Prototype_Agents.CommunicationAnalyzerAgent";
