...
public class RequestPerformer extends Behaviour {
	...
	public RequestPerformer(WorkpieceAgent myAgent, Operation requested_operation, Long startdate_for_this_task, Boolean last_operation, Boolean error_handling_active) { //start_date of production / startdate is null in case of transport 
		super(myAgent);
	...
	public RequestPerformer(WorkpieceAgent myAgent, Operation buffer, Timeslot timeslot_to_book_buffer_place, Boolean last_operation, boolean error_handling_active) {
		super(myAgent);
		this.myAgent = myAgent;	
	...
	public RequestPerformer(WorkpieceAgent myAgent, Operation requested_operation, long startdate_for_this_task,
