...
public class RequestPerformer extends Behaviour {
	...
	public RequestPerformer(WorkpieceAgent myAgent, Operation requested_operation, Long startdate_for_this_task, Boolean last_operation) { //start_date of production / startdate is null in case of transport 
		super(myAgent);
	...
	public void action() {
		...
		case 2:
			...
			myAgent.receiveProposals(conversationID, proposal_senders, received_proposals);												
			myAgent.receiveRejection(conversationID, proposal_senders, received_proposals);		
